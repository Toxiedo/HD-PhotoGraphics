...
namespace HD_PhotoGraphics
{
    public partial class EdgeDetection : Form
    {
        ...
        {
            float[,] operation_mask = { { -1, -2, -1 }, { 0, 0, 0 }, { 1, 2, 1 } };
            pictureBox2.Image = display_image(Post_processing((Linear_filter(ref fst_image.image_buffer, ref operation_mask, "abs")), "cutoff"));
            MessageBox.Show("Congratulations , Edges detected succsefully , Using : Apply Horizontal sobel Line detection");
        }

        private void button3_Click(object sender, EventArgs e)
        {
            float[,] operation_mask = { { -1, 0, 1 }, { -2, 0, 2 }, { -1, 0, 1 } };
            pictureBox2.Image = display_image(Post_processing((Linear_filter(ref fst_image.image_buffer, ref operation_mask, "abs")), "cutoff"));
            MessageBox.Show("Congratulations , Edges detected succsefully , Using : Apply Vertical sobel Line detection");
        }
